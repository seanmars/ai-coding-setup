...
# Ref: https://github.com/ericburcham/claude-code-uninstaller/blob/main/cc-uninstall.sh
...
main() {
    ...
    if [ "$FORCE" = false ] && [ "$QUIET" = false ]; then
        echo -e "${YELLOW}This will completely remove Claude Code from your system.${NC}"
    ...
    echo ""
    echo -e "${GREEN}✅ Claude Code has been successfully removed from your system.${NC}"
    echo ""
